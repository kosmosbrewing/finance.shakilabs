...
<template>
  <!-- 내 건보료 결과가 아니라 다른 연봉대 참고표라 기본은 접어 둔다 (SalaryCompareTable과 동일 처방) -->
  <details class="group retro-panel overflow-hidden">
    ...
    <div
      ...
      tabindex="0"
    >
      <table aria-label="건강보험료별 연봉 환산 표" class="w-full min-w-[560px] table-fixed lg:min-w-0 border-separate border-spacing-0 text-xs md:text-caption">
        <colgroup>
