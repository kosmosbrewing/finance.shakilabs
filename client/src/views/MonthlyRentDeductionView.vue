...
<template>
  <div class="sh-container sh-container--tool space-y-4 py-6">
    ...
    <CalculatorPageHeader title="월세 세액공제 계산기" />
    ...
    <CalculatorInteractionTracker>
      <ShCalculatorSplit>
        <template #input>
          <section class="retro-panel overflow-hidden" aria-labelledby="monthly-rent-input-title">
            <div class="retro-titlebar rounded-t-2xl">
              <h2 id="monthly-rent-input-title" class="retro-title">월세 조건 입력</h2>
            </div>
        ...
        <template #result>
          <section class="retro-panel overflow-hidden" aria-labelledby="monthly-rent-result-title">
            <div class="retro-titlebar rounded-t-2xl">
              <h2 id="monthly-rent-result-title" class="retro-title">월세 세액공제 예상 결과</h2>
            </div>
            <div class="retro-panel-content space-y-4">
    ...
    <CalculatorFeedbackRow page-key="monthly-rent-main" />
  </div>
</template>
