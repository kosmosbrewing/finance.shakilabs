...
<template>
  <div class="sh-container sh-container--tool space-y-4 py-6">
    ...
    <CalculatorPageHeader title="국민연금 예상 수령액" />
    ...
    <CalculatorInteractionTracker>
      <ShCalculatorSplit>
        <template #input>
          <section class="retro-panel overflow-hidden" aria-labelledby="pension-input-title">
            <div class="retro-titlebar rounded-t-2xl">
              <h2 id="pension-input-title" class="retro-title">가입 조건 입력</h2>
            </div>
        ...
        <template #result>
          <section class="retro-panel overflow-hidden" aria-labelledby="pension-result-title">
            <div class="retro-titlebar rounded-t-2xl">
              <h2 id="pension-result-title" class="retro-title">국민연금 예상 결과</h2>
            </div>
            <div class="retro-panel-content space-y-4">
    ...
    <CalculatorFeedbackRow page-key="pension-main" />
  </div>
</template>
