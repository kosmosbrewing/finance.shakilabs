const GUIDES = {
  ...
  "/eitc": {
    ...
    method: "가구 유형별 점증·평탄·점감 구간 산식에 총급여를 적용하고, 재산 1억7천만원 이상 50% 감액과 2억4천만원 이상 지급 제외를 반영합니다.",
    limit: "실제 산정표의 소득 구간 단위·단수 조정과 국민연금 수급 등 제외 요건은 반영하지 않는 간이 계산입니다.",
  ...
  "/unpaid-wage": {
    ...
    method: "체불액에 적용 단계별 이율(퇴직 후 20%, 민법 5%, 상법 6%, 소송촉진법 12%)과 이자 발생일수를 곱해 계산합니다. 퇴직 단계는 금품청산 14일을 제외합니다.",
    limit: "도산·회생 등 지연이자 적용 제외 사유와 일부 변제, 판결 주문별 이율 변경은 반영하지 않습니다.",
