...
export const HOME_FAQS = [
  {
    ...
    a: "지금 손에 있는 숫자로 고르면 빠릅니다. 세전 연봉을 알고 있다면 이 화면 맨 위 퀵계산기, 급여명세서의 건강보험료만 알고 있다면 건강보험료 역산 계산기, 제안받은 연봉이 두 개라면 이직 연봉 비교가 출발점입니다. 무엇을 넣어야 할지 모르겠다면 아래 목록에서 줄마다 적어 둔 '무엇을 넣으면 무엇이 나오는지'를 읽고 가장 가까운 줄을 고르세요.",
  },
  {
    q: "맨 위 퀵계산기와 연봉 실수령액 계산기는 결과가 다른가요?",
    a: "같은 연봉을 넣으면 1원 단위까지 같습니다. 두 화면은 같은 계산 엔진을 씁니다. 다른 것은 입력 칸 수뿐입니다. 퀵계산기는 부양가족·비과세·퇴직금 조건을 표준값으로 고정해 연봉 한 칸만 받고, 연봉 실수령액 계산기는 그 조건을 직접 바꿔 가며 공제 항목별 금액까지 펼쳐 보여줍니다.",
  },
  {
...
export const HOME_FAQ_INTRO =
  "계산 방법이 아니라 '지금 무엇을 열어야 하는가'에 대한 답입니다. 계산기별 질문은 각 계산기 화면 아래에 따로 있습니다.";
...
export const HOME_GUIDE_LINKS_INTRO =
  "사건 하나가 계산기 여러 개에 걸치면 순서 가이드가 빠릅니다. 단계마다 무엇을 여는지와 앞 단계 결과를 어디에 넣는지가 적혀 있습니다.";
